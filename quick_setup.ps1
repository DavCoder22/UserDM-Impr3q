# Script rápido para verificar microservicios

Write-Host "=== VERIFICACIÓN RÁPIDA DE MICROSERVICIOS ===" -ForegroundColor Green
...
function Start-Verification {
    Write-Host "Iniciando verificación de microservicios..." -ForegroundColor Yellow
